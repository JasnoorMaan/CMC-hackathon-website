...
let FAQ = function () {
    ...
    return (
        <div className="flex flex-col  justify-center items-center  w-full py-10 md:py-20 ">
            <h1 className="   text-white  text-3xl md:text-4xl font-extrabold items-center pb-4 text-center ">FAQs</h1>
            <div className="bg-[#212631] shadow-3xl  h-[332px] mb-10 p-6 md:h-80 md:px-10 md:pt-10 md:pb-16  border w-11/12 sm:w-8/12 border-black  flex flex-col rounded-lg justify-items-center items-center">
            ...
            <div className=" bg-[#212631] w-[60%] rounded-lg   h-4 relative border shadow-3xl border-black">
                <div className="w-[98px] h-[60px] absolute -top-6 left-[50%] -translate-x-[50%] rounded-full flex bg-[#212631] justify-center gap-3  items-center border border-black">
